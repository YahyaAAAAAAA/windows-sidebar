...
extension IntExtensions on int? {
  ...
  EdgeInsets get pButL => EdgeInsets.only(
    top: validate().toDouble(),
    bottom: validate().toDouble(),
    right: validate().toDouble(),
    left: 0,
  );
  EdgeInsets get pButR => EdgeInsets.only(
    top: validate().toDouble(),
    bottom: validate().toDouble(),
    left: validate().toDouble(),
    right: 0,
  );
  EdgeInsets get pButT => EdgeInsets.only(
    bottom: validate().toDouble(),
    left: validate().toDouble(),
    right: validate().toDouble(),
    top: 0,
  );
  EdgeInsets get pButB => EdgeInsets.only(
    top: validate().toDouble(),
    left: validate().toDouble(),
    right: validate().toDouble(),
    bottom: 0,
