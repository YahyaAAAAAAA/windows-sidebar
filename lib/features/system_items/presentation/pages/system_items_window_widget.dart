...
class SystemItemsWindowWidget extends StatefulWidget {
  final int id;

  const SystemItemsWindowWidget({super.key, required this.id});

  @override
  State<SystemItemsWindowWidget> createState() => _SystemItemsWindowWidgetState();
}

class _SystemItemsWindowWidgetState extends State<SystemItemsWindowWidget> {
  ...
  void onItemFocusChange(int index, bool value) {
    ...
    if (value) cubit.bringToFront(window);
  }
